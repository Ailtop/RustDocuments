...
public class SocketMod_PhysicMaterial : SocketMod
{
	...
	{
		if (Physics.Raycast(place.position + place.rotation.eulerAngles.normalized * 0.5f, -place.rotation.eulerAngles.normalized, out var hitInfo, 1f, 27328512, QueryTriggerInteraction.Ignore))
		{
