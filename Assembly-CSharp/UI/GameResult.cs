...
namespace UI
{
	public class GameResult : MonoBehaviour
	{
		...
		public bool showEarlyAccessEndingTitle { get; set; }

		public string earlyAccessText { get; set; }
		...
		private void OnEnable()
		{
			...
			if (showEarlyAccessEndingTitle)
			{
				_stageName.text = earlyAccessText;
			}
			else
			{
				_stageName.text = Singleton<Service>.Instance.levelManager.currentChapter.stageName;
			}
			UpdateGearList();
		}
