...
public class RustPlatformHooks : IPlatformHooks
{
	...
	public ServerParameters? ServerParameters
	{
		get
		{
			...
			return new ServerParameters("rust", "Rust", 2256.ToString(), ConVar.Server.secure, address, (ushort)Network.Net.sv.port, (ushort)(flag ? ((ushort)ConVar.Server.queryport) : 0));
		}
	}
