...
internal sealed class ScreenSpaceReflectionsRenderer : PostProcessEffectRenderer<ScreenSpaceReflections>
{
	...
	public override void Render(PostProcessRenderContext context)
	{
		...
		RuntimeUtilities.BlitFullscreenTriangle(command, context.source, UnityEngine.Rendering.PostProcessing.ShaderIDs.Test, propertySheet, 0);
		...
		else
		{
			...
			RuntimeUtilities.BlitFullscreenTriangle(command, context.source, UnityEngine.Rendering.PostProcessing.ShaderIDs.SSRResolveTemp, propertySheet, 1);
			propertySheet.properties.SetTexture(UnityEngine.Rendering.PostProcessing.ShaderIDs.History, m_History);
			RuntimeUtilities.BlitFullscreenTriangle(command, UnityEngine.Rendering.PostProcessing.ShaderIDs.SSRResolveTemp, m_Resolve, propertySheet, 2);
