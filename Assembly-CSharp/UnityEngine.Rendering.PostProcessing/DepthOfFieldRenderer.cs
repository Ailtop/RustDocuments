...
internal sealed class DepthOfFieldRenderer : PostProcessEffectRenderer<DepthOfField>
{
	...
	public override void Render(PostProcessRenderContext context)
	{
		...
		RuntimeUtilities.BlitFullscreenTriangle(command, BuiltinRenderTextureType.None, UnityEngine.Rendering.PostProcessing.ShaderIDs.CoCTex, propertySheet, 0);
		...
		RuntimeUtilities.BlitFullscreenTriangle(command, context.source, UnityEngine.Rendering.PostProcessing.ShaderIDs.DepthOfFieldTex, propertySheet, 2);
		...
		RuntimeUtilities.BlitFullscreenTriangle(command, UnityEngine.Rendering.PostProcessing.ShaderIDs.DepthOfFieldTex, UnityEngine.Rendering.PostProcessing.ShaderIDs.DepthOfFieldTemp, propertySheet, (int)(3 + base.settings.kernelSize.value));
		RuntimeUtilities.BlitFullscreenTriangle(command, UnityEngine.Rendering.PostProcessing.ShaderIDs.DepthOfFieldTemp, UnityEngine.Rendering.PostProcessing.ShaderIDs.DepthOfFieldTex, propertySheet, 7);
