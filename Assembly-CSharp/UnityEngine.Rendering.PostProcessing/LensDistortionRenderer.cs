...
internal sealed class LensDistortionRenderer : PostProcessEffectRenderer<LensDistortion>
{
	public override void Render(PostProcessRenderContext context)
	{
		...
		uberSheet.properties.SetVector(UnityEngine.Rendering.PostProcessing.ShaderIDs.Distortion_CenterScale, value);
		uberSheet.properties.SetVector(UnityEngine.Rendering.PostProcessing.ShaderIDs.Distortion_Amount, value2);
	}
}
