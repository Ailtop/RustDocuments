	...
	public class CoverPointsInRangeSensor : INpcSensor
	{
		...
		public void Tick(IHTNAgent npc, float deltaTime, float time)
		{
			...
			if (!(scientistDomain == null) && scientistDomain.ScientistContext != null)
			{
				...
				float allowedCoverRangeSqr = scientistDomain.GetAllowedCoverRangeSqr();
				_FindCoverPointsInVolume(npc.transform.position, scientistDomain.ScientistContext.CoverPoints, ref scientistDomain.ScientistContext.CoverVolume, ref nextCoverPosInfoTick, time, scientistDomain.ScientistContext.Location, allowedCoverRangeSqr);
			}
		}
