...
public static class World
{
	...
	public static string MapFileName
	{
		get
		{
			...
			return Name.Replace(" ", "").ToLower() + "." + Size + "." + Seed + "." + 223 + ".map";
		}
	}
	...
	public static string SaveFileName
	{
		get
		{
			...
			return Name.Replace(" ", "").ToLower() + "." + Size + "." + Seed + "." + 223 + ".sav";
		}
	}
	...
	public static void CleanupOldFiles()
	{
		...
		Regex regex2 = new Regex("\\.[0-9]+\\.[0-9]+\\." + 223 + "\\.map");
	...
	{
		return SystemInfo.deviceUniqueIdentifier + "_" + 223 + "_" + Server.identity;
	}
