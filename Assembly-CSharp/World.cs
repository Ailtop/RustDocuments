...
public static class World
{
	...
	public static string MapFileName
	{
		get
		{
			...
			return Name.Replace(" ", "").ToLower() + "." + Size + "." + Seed + "." + 201 + ".map";
		}
	}
	...
	public static string SaveFileName
	{
		get
		{
			...
			return Name.Replace(" ", "").ToLower() + "." + Size + "." + Seed + "." + 201 + ".sav";
		}
	}
	...
	public static void CleanupOldFiles()
	{
		...
		Regex regex2 = new Regex("\\.[0-9]+\\.[0-9]+\\." + 201 + "\\.map");
	...
	{
		return SystemInfo.deviceUniqueIdentifier + "_" + 201 + "_" + Server.identity;
	}
